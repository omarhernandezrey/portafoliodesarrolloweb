...
const services = [
  {
    ...
    description: 'Creating modern, responsive user interfaces using technologies like React and Next.js.',
  ...
  },
  {
    ...
    description: 'Building robust, scalable APIs with Node.js, Express, and SQL/NoSQL databases.',
  ...
  },
  {
    ...
    features: ['CI/CD Pipelines', 'Cloud Infrastructure', 'Container Orchestration', 'Monitoring'],
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Comprehensive solutions tailored to bring your digital vision to life with cutting-edge technology and best practices
            </p>
          </motion.div>
